...
#define	CONFIG_EXTRA_ENV_SETTINGS					\
		...
		"bootargs_android=setenv bootargs ${bootargs} "		\
			"androidboot.console=ttymxc0 init=/init keypad\0"	\
		"bootcmd_mmc=run bootargs_base bootargs_video bootargs_android;"	\
			"mmc read 2 ${loadaddr} 0x2000 0x1800;mmc read 2 ${rd_loadaddr} 0x3800 0x200;bootm ${loadaddr} ${rd_loadaddr}\0"	\
 ...
 */
	...
	#define CONFIG_ELINK_60_HD_PVI_PANEL
