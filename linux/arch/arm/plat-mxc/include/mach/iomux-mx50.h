...
#define MX50_GPIO_KEY_PAD_CTRL	(PAD_CTL_PKE | PAD_CTL_PUE | \
...
#define MX50_GPIO_2_9_CTRL (PAD_CTL_PKE | PAD_CTL_PUE | \
							PAD_CTL_PUS_100K_UP | PAD_CTL_DSE_HIGH)

#define MX50_GPIO_2_14_CTRL (PAD_CTL_PKE | PAD_CTL_PUE | \
							PAD_CTL_PUS_100K_UP | PAD_CTL_DSE_HIGH)


#define MX50_PAD_KEY_COL0__GPIO_4_0	IOMUX_PAD(0x2CC, 0x20, 1, 0x0, 0, MX50_GPIO_KEY_PAD_CTRL)
#define MX50_PAD_KEY_ROW0__GPIO_4_1	IOMUX_PAD(0x2D0, 0x24, 1, 0x0, 0, MX50_GPIO_KEY_PAD_CTRL)
#define MX50_PAD_KEY_COL1__GPIO_4_2	IOMUX_PAD(0x2D4, 0x28, 1, 0x0, 0, MX50_GPIO_KEY_PAD_CTRL)
#define MX50_PAD_KEY_ROW1__GPIO_4_3	IOMUX_PAD(0x2D8, 0x2C, 1, 0x0, 0, MX50_GPIO_KEY_PAD_CTRL)
#define MX50_PAD_KEY_COL2__GPIO_4_4	IOMUX_PAD(0x2DC, 0x30, 1, 0x0, 0, MX50_GPIO_KEY_PAD_CTRL)
#define MX50_PAD_KEY_ROW2__GPIO_4_5	IOMUX_PAD(0x2E0, 0x34, 1, 0x0, 0, MX50_GPIO_KEY_PAD_CTRL)
#define MX50_PAD_KEY_COL3__GPIO_4_6	IOMUX_PAD(0x2E4, 0x38, 1, 0x0, 0, MX50_GPIO_KEY_PAD_CTRL)
...
#define MX50_PAD_SSI_EXT1_CLK		IOMUX_PAD(0x30C, 0x60, 3, 0x0, 0, NO_PAD_CTRL)
...
#define MX50_PAD_ECSPI1_MISO__GPIO_4_14	IOMUX_PAD(0x378, 0xCC, 1, 0x0, 0, MX50_GPIO_KEY_PAD_CTRL)

/* HP detect */
#define MX50_PAD_ECSPI1_SS0__GPIO_4_15	IOMUX_PAD(0x37C, 0xD0, 1, 0x0, 0, MX50_GPIO_KEY_PAD_CTRL)
#define MX50_PAD_ECSPI2_SCLK__GPIO_4_16	IOMUX_PAD(0x380, 0xD4, 1, 0x0, 0, MX50_GPIO_KEY_PAD_CTRL)
...
#define MX50_PAD_DISP_RS__GPIO_2_17	IOMUX_PAD(0x434, 0x154, 1, 0x0, 0, PAD_CTL_PKE | PAD_CTL_PUE | \
																PAD_CTL_PUS_100K_UP | PAD_CTL_DSE_HIGH)
...
#define MX50_PAD_DISP_D9__GPIO_2_9	IOMUX_PAD(0x474, 0x194, 1, 0x0, 0, MX50_GPIO_2_9_CTRL)
...
#define MX50_PAD_DISP_D14__GPIO_2_14	IOMUX_PAD(0x488, 0x1A8, 1, 0x0, 0, MX50_GPIO_2_14_CTRL)
...
#define MX50_PAD_EIM_RW__GPIO_1_25	IOMUX_PAD(0x65C, 0x2C0, 1, 0x0, 0, PAD_CTL_PUS_100K_DOWN)
#define MX50_PAD_EIM_LBA__GPIO_1_26	IOMUX_PAD(0x660, 0x2C4, 1, 0x0, 0, MX50_GPIO_KEY_PAD_CTRL)
#define MX50_PAD_EIM_CRE__GPIO_1_27	IOMUX_PAD(0x664, 0x2C8, 1, 0x0, 0, MX50_GPIO_KEY_PAD_CTRL)
