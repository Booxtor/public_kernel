...
void touchpanel_resume_pads(void)
{
	...
	gpio_direction_output(I2C3_SCL_GPIO_6_22, 1);
	gpio_direction_output(I2C3_SDA_GPIO_6_23, 1);
...
void pull_down_touchpanel_pins(void){
	...
	/*Pull down UART pads*/
	gpio_request(UART2_TXD_GPIO_6_10, "gpio_6_10");
	gpio_request(UART2_RXD_GPIO_6_11, "gpio_6_11");
	gpio_direction_output(UART2_TXD_GPIO_6_10, 0);
	gpio_direction_output(UART2_RXD_GPIO_6_11, 0);
	gpio_free(UART2_TXD_GPIO_6_10);
	gpio_free(UART2_RXD_GPIO_6_11);
 ...
 */
const char product_proc_banner[] ="%s\n";
static int version_proc_show(struct seq_file *m, void *v)
{
	seq_printf(m, product_proc_banner, LINUX_PRODUCT);
	return 0;
}
...
static const struct file_operations product_proc_fops = {
...
static void __init mxc_board_init(void)
{
	...
	*/
    ...
    proc_create("product", 0, NULL, &product_proc_fops);
}
 ...
 */
MACHINE_START(MX50_ARM2, "Onyx eReader")
